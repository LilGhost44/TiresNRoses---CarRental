...
/*Condition report Entity*/

@Entity
@Table(name = "CONDITIONREPORT")
public class JPAConditionReport {
    @Id
    ...
    //constructor
    public JPAConditionReport(){};
    public JPAConditionReport(int reportID, int rentalID, String scratches, String interiorDamage, String tireCondition, String notes, ReportStage stage) {
